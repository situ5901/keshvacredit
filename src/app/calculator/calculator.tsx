...
export default function EmiCalculator() {
    ...
    const calculateEMI = () => {
        ...
        setTotalData({
            ...
            totalInterestPayable: formatCurrency(totalInterestPayable),
            totalAmount: formatCurrency(totalPayment + totalInterestPayable)
        });
        setShowResult(true);
    };
    ...
    <div className="max-w-4xl mx-auto p-6 bg-red rounded-lg flex gap-10">
            ...
            <div className="w-1/2 p-4 bg-blue-100 shadow-lg rounded-lg animate-fade-in">
                {/* Ye title aur subtitle sirf tab tak dikhega jab tak result nahi aata */}
                {!showResult && (
