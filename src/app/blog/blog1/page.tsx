// app/blog/how-to-save-tax/page.tsx
export default function SaveTaxBlog() {
  return (
    <main className="p-6 max-w-4xl mx-auto mt-15">
      ...
      <section className="space-y-6 text-lg  leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold">1. Understand the Basics of Income Tax</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">2. Section 80C – Your Primary Tax-Saving Tool</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">3. Use the National Pension Scheme (NPS) – Section 80CCD(1B)</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">4. Claim HRA – House Rent Allowance</h2>
        <p>
          If you live in a rented house, HRA can be a significant tax saver. To claim HRA:
        </p>
        <ul className="list-disc pl-6">
          <li>Your salary structure must include HRA</li>
          <li>You should be paying rent</li>
          <li>You need to submit rent receipts as proof</li>
        </ul>
        <p>
          The exemption amount depends on factors like your salary, HRA received, rent paid, and location of residence.
        </p>

        <h2 className="text-2xl font-semibold">5. Deduction on Home Loan Interest – Section 24(b)</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">6. Health Insurance – Section 80D</h2>
        <p>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>Additional ₹25,000 (or ₹50,000 if parents are senior citizens) for parents</li>
        </ul>
        <p>
          This not only provides financial security but also helps reduce taxes.
        </p>

        <h2 className="text-2xl font-semibold">7. Education Loan – Section 80E</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">8. Leave Travel Allowance (LTA)</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">9. Standard Deduction</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">10. Donations – Section 80G</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">11. Choose Between Old and New Regimes</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold">12. Reimbursements and Perks</h2>
        <p>
