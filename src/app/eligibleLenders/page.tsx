...
const allLenders: Lender[] = [
  ...
  },
  {
    id: "kamakshi",
    name: "kamakshi",
    logo: "https://www.kamakshimoney.com/index_files/finpath-loan-logo.svg",
    approval: "Good",
    amount: "Up to ₹3,00,000",
    interest: " upto 24% per annum",
    tenure: "Up to 18 months",
  ...
  },
  {
    ...
    support: "24/7 customer support",
    features: ["No Collateral", "Flexible Repayment", "No Usage Restriction"],
    applyLink: "/lenderapi/instantmudra",
  },
  {
