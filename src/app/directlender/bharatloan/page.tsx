...
function Page() {
        ...
        const fetchUser = async () => {
            ...
            if (phone) {
                ...
                if (user && user.phone) {
                    ...
                    window.location.href = "https://www.bharatloan.com/apply-now?utm_source=KESHVACREDIT&utm_medium=";
                } else {
                    setLoading(false);
                }
            } else {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setTimeout(() => {
                setShowPopup(false);
                window.open("https://www.bharatloan.com/apply-now?utm_source=KESHVACREDIT&utm_medium=");
            }, 2000);
