...
function Page() {
        ...
        const fetchUser = async () => {
            ...
            if (phone) {
                ...
                if (user && user.phone) {
                    ...
                    window.location.href = "https://www.rupee112.com/apply-now?utm_source=KESHVACREDIT&utm_medium=";
                } else {
                    setLoading(false);
                }
            } else {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setTimeout(() => {
                setShowPopup(false);
                window.open("https://www.rupee112.com/apply-now?utm_source=KESHVACREDIT&utm_medium=");
            }, 2000);
            ...
            <div className="justify-center mb-20 items-center min-h-screen">
                <div className="mt-24 mx-auto max-w-[90%] md:max-w-[50rem] text-center text-[28px] md:text-[34px]">
                    <h1 className="font-bold text-[34px]">
                        rupee112 personal Loans starting at{" "}
