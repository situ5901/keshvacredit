...
function Page() {
        ...
        const fetchUser = async () => {
            ...
            if (phone) {
                ...
                if (user && user.phone) {
                    ...
                    window.location.href = "https://zype.sng.link/Ajygt/1ba7?_dl=com.zype.mobile&_smtype=3";
                } else {
                    setLoading(false);
                }
            } else {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setTimeout(() => {
                setShowPopup(false);
                window.open("https://zype.sng.link/Ajygt/1ba7?_dl=com.zype.mobile&_smtype=3");
            }, 2000);
            ...
            <div className="justify-center mb-20 items-center min-h-screen">
                <div className="mt-24 mx-auto max-w-[90%] md:max-w-[50rem] text-center text-[28px] md:text-[34px]">
                    <h1 className="font-bold text-[34px]">
                        Zype personal Loans starting at{" "}
