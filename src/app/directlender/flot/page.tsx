...
function Page() {
        ...
        const fetchUser = async () => {
            ...
            if (phone) {
                ...
                if (user && user.phone) {
                    ...
                    window.location.href = "https://myflot.com/?utm_source=Keshvacredit&utm_medium=%7B_medium%7D&utm_campaign=%7B_campaign%7D";
                } else {
                    setLoading(false);
                }
            } else {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setTimeout(() => {
                setShowPopup(false);
                window.open("https://myflot.com/?utm_source=Keshvacredit&utm_medium=%7B_medium%7D&utm_campaign=%7B_campaign%7D");
            }, 2000);
            ...
            <div className="justify-center mb-20 items-center min-h-screen">
                <div className="mt-24 mx-auto max-w-[90%] md:max-w-[50rem] text-center text-[28px] md:text-[34px]">
                    <h1 className="font-bold text-[34px]">
                        Flot personal Loans starting at{" "}
                        <span className="text-blue-700">2% per month</span> Interest Rates.
                    </h1>
