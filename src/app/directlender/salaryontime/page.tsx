...
function Page() {
        ...
        const fetchUser = async () => {
            ...
            if (phone) {
                ...
                if (user && user.phone) {
                    ...
                    window.location.href = "https://salaryontime.com/apply-now?utm_source=Keshvacredit&utm_medium=Keywords&utm_campaign=Keywords&utm_term=Keywords";
                } else {
                    setLoading(false);
                }
            } else {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setTimeout(() => {
                setShowPopup(false);
                window.open("https://salaryontime.com/apply-now?utm_source=Keshvacredit&utm_medium=Keywords&utm_campaign=Keywords&utm_term=Keywords");
            }, 2000);
            ...
            <div className="justify-center mb-20 items-center min-h-screen">
                <div className="mt-24 mx-auto max-w-[90%] md:max-w-[50rem] text-center text-[28px] md:text-[34px]">
                    <h1 className="font-bold text-[34px]">
                        Salary On Time personal Loans starting at{" "}
                        <span className="text-blue-700">upto 2.9166% per month</span> Interest Rates.
                    </h1>
