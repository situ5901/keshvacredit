    ...
    async (autoData: FormData) => {
      try {
        const payload = {
          ...
          dob: autoData.dob,
          gender: "", // optional dropdown later
        };
        ...
        if (responseData?.apiResponse?.token) {
          setIsSuccess(true);
          setResponseMsg(
            "🎉 Congratulations! Your application has been submitted. We are now proceeding to the next steps."
          );
          setTimeout(() => {
            router.push(
