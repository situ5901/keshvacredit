...
function CreditCard() {
  return (
    <>
      <section className="bg-white text-amber-50 mt-10">
        <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
          ...
          <h1 className="mb-4 text-4xl font-bold tracking-tight leading-none text-blue-950 lg:mb-6 md:text-5xl xl:text-6xl">
            Under Maintenance
          </h1>
